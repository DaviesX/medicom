...
export const c_Root_Actions = [
        ...
        {action: "assign association",          scope: [-1], grant_option: true},
        {action: "activate association",        scope: [-1], grant_option: true},
        {action: "deactivate association",      scope: [-1], grant_option: true},
        {action: "view association",            scope: [-1], grant_option: true},
        {action: "update association",          scope: [-1], grant_option: true},
...
export const c_Assistant_Actions = [
        ...
        {action: "view association",            scope: [-2], grant_option: false},
        {action: "search association",          scope: [-2], grant_option: false},
...
export const c_Provider_Actions = [
        ...
        {action: "assign association",          scope: [-2], grant_option: true},
        {action: "activate association",        scope: [-2], grant_option: false},
        {action: "deactivate association",      scope: [-2], grant_option: false},
        {action: "view association",            scope: [-2], grant_option: true},
        {action: "update association",          scope: [-2], grant_option: true},
        {action: "search association",          scope: [-2], grant_option: true},
        {action: "update measure",              scope: [-2], grant_option: true},
        {action: "remove measure",              scope: [-2], grant_option: true},
        {action: "view measure",                scope: [-2], grant_option: true},
];
