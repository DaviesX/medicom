...
export function TestPrepareSampleData(to_reset) {
        ...
        sym_measures.add_row(new Date(2016, 6, 15), {
                patients_feel: 5,
        ...
        sym_measures.add_row(new Date(2016, 6, 16), {
                patients_feel: 4,
        ...
        sym_measures.add_row(new Date(2016, 6, 17), {
                patients_feel: 2,
        ...
        sym_measures.add_row(new Date(2016, 6, 18), {
                patients_feel: 3,
        ...
        sym_measures.add_row(new Date(2016, 6, 19), {
                patients_feel: 4,
        ...
        sym_measures.add_row(new Date(2016, 6, 20), {
                patients_feel: 5,
                description: "Antiopam tractatos eu quo, et agam prompta mel, appareat adipiscing vis ne. Te eos simul bonorum, pri an elit dissentiet, vis semper docendi definitiones at. Pri ei principes disputationi. Id liber aeque persius qui, mea ut movet tibique praesent."
        });
