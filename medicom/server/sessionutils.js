...
export function SessionUtils() {
        ...
        this.has_relation = function(provider_id, patient_id, err) {
                return G_DataModelContext.get_session_manager().has_session(provider_id, patient_id);
        }
        ...
        this.get_participated_patient_ids = function(provider_id, err) {
                var sessions = G_DataModelContext.get_session_manager().
        ...
        this.get_sessions = function(provider_id, patient_id, err) {
                return G_DataModelContext.get_session_manager().get_sessions_by_ids(
